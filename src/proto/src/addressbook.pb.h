...
// required string status = 4;
inline bool Person::has_status() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void Person::set_has_status() {
  _has_bits_[0] |= 0x00000008u;
}
inline void Person::clear_has_status() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void Person::clear_status() {
  if (status_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    status_->clear();
  }
  clear_has_status();
}
inline const ::std::string& Person::status() const {
  // @@protoc_insertion_point(field_get:tutorial.Person.status)
  return *status_;
}
inline void Person::set_status(const ::std::string& value) {
  set_has_status();
  if (status_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    status_ = new ::std::string;
  }
  status_->assign(value);
  // @@protoc_insertion_point(field_set:tutorial.Person.status)
}
inline void Person::set_status(const char* value) {
  set_has_status();
  if (status_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    status_ = new ::std::string;
  }
  status_->assign(value);
  // @@protoc_insertion_point(field_set_char:tutorial.Person.status)
}
inline void Person::set_status(const char* value, size_t size) {
  set_has_status();
  if (status_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    status_ = new ::std::string;
  }
  status_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:tutorial.Person.status)
}
inline ::std::string* Person::mutable_status() {
  set_has_status();
  if (status_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    status_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:tutorial.Person.status)
  return status_;
}
inline ::std::string* Person::release_status() {
  clear_has_status();
  if (status_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
...
inline void Person::set_allocated_status(::std::string* status) {
  if (status_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete status_;
  }
  if (status) {
  ...
  // @@protoc_insertion_point(field_set_allocated:tutorial.Person.status)
}
